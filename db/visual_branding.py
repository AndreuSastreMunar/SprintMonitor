...
@media(max-width:640px){.cteib-brand-lockup{margin:.05rem 0 .9rem;gap:.35rem}.cteib-brand-top{font-size:2.1rem}.cteib-brand-bottom{font-size:1.72rem}.hero{margin-bottom:1rem!important}.hero:after{display:none}.hello{font-size:2rem!important}.sub{font-size:.92rem!important}.menu-card{min-height:158px!important;border-radius:22px!important;padding:1rem!important}.menu-icon{width:52px!important;height:52px!important;border-radius:16px!important;font-size:1.65rem!important;margin-bottom:.55rem}.menu-title{font-size:1.08rem!important}.menu-sub{font-size:.84rem!important}.menu-num{width:31px!important;height:31px!important;margin-top:.65rem!important}.menu-card:after{right:.95rem;bottom:.82rem;font-size:1.35rem}}
...
def install_visual_branding():
    ...
    def markdown_with_brand(body, *args, **kwargs):
        # db se importa antes de st.set_page_config. Por eso el CSS no debe
        # renderizarse aquí en la instalación, sino en el primer markdown real
        # que app.py ejecuta después de configurar la página.
